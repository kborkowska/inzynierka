...
\tikzsetnextfilename{simpMPD}
	\begin{tikzpicture}
			...
			[
			width=0.9\textwidth,
			xmin=0,xmax=22.5,ymin=0,ymax=410,
			xlabel={$t$},
			ylabel={$Position$},
			xtick={0,5,10,15,20},
			...
			\addplot[magenta,semithick] file {SymulationResults/MPD:20.000000:10.000000:0.000000:400.000000/joint-1-setpoint.txt};
			\nextgroupplot
			[
			width=0.9\textwidth,
			xmin=0,xmax=22.5,ymin=0,ymax=410,
			...
			\addplot[blue,semithick] file {SymulationResults/MPD:20.000000:10.000000:0.000000:400.000000/joint-1-result.txt};
			\end{groupplot}
			\end{tikzpicture}
	\end{figure}
\end{document}